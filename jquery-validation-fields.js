/*
 * jQuery Validation Fields 1.0 by Francesco De Stefano © 2013
...
// inizializzo il plugin
   ...
   $.validate = function(obj, options) {
      var settings = {
         ...
         color_border: '',
         effect: '',
         match_text: 'Values must be identical', // default
         match_id: null,
         length_min: '',
         length_max: '',
         value_min: '',
         ...
         disallowfirstchoice: false, // default
         nohint: false,
      ...
      if (settings.title_text == '') {
         settings.title_text = $(obj).attr("title"); 
         // selezioni l'attributo titolo del campo per il messaggio di validazione
      }
   ...
   function validateform($obj)  {
    ...
    var resetbtn = $("button[type='reset'], input[type='reset']");     
   ...
   function setBubbleColor(obj, color, border) {
     ...
     $(obj).find(".bubbleArrow .line1").css("background-color", border);
     $(obj).find(".bubbleArrow .line2").css("background-color", border);
     $(obj).find(".bubbleContent").css("border-color", border);
     $(obj).find(".bubbleArrow div").css("border-color", border);
     $(obj).find(".bubbleArrow .line3").css("border-color", border);
   }
